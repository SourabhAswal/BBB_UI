...
export default class UsersList extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      const users = await userDetails.get_LoggedIn_Users()
        ...
        <div id="usdiv" >
          <div className="card mx-auto " style={{ width: "400px", height: "170px", borderRadius: '5px', marginBottom: "25px", marginTop: "1%", marginLeft: '5000px !important' }}>
            <div className="header">
              <div className="card-header text-center" style={{ backgroundColor: "#eaecf4" }}><h2 style={{ color: "#6e707e",marginLeft : '70px' }}> Attendee List</h2></div>
            </div>
            ...
            <ReactToPrint
   trigger={() => <button type="button" disabled={btnview} id='button-web' style={{marginLeft: "31px", marginTop: "20px", marginBottom : '15px'}}  >Print </button>}
 ...
 <div style={{display:"none"}}><Table  columns={columns} data={rows} ref={el => (this.componentRef = el)} /></div>
        ...
        <div className="ml-3" id="tableprint">
